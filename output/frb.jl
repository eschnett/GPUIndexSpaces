...
#     Unused: [Kd0, Kd1]
begin
    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:527 =#
    begin
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:640 =#
    ...
    begin
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09))] = Ezero_0
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + 128)] = Ezero_1
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + 2048)] = Ezero_2
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + (128 + 2048))] = Ezero_3
    end
    begin
        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:544 =#
        for loopIdx4 = Int32(0):Int32(255)
            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:545 =#
            begin
                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:527 =#
                begin
                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:544 =#
                            ...
                            begin
                                ...
                                for loopIdx1 = Int32(0):Int32(2)
                                    ...
                                    begin
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds fI_mem[1 + ((loopIdx4 % Int32) << 0x15 + (loopIdx2 % Int32) << 0x0a + (loopIdx1 % Int32) << 0x0c + (((blockIdx()).x - 1) % Int32) << 0x0e + (((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = fIzero
                                        end
                                    end
                                end
                            end
                    ...
                    for loopIdx3 = Int32(0):Int32(15)
                        ...
                        begin
                            ...
                            begin
                                ...
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E_0 = E_mem[1 + ((loopIdx4 % Int32) << 0x16 + (loopIdx3 % Int32) << 0x12 + (((blockIdx()).x - 1) % Int32) << 0x08 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x05 + ((((threadIdx()).y - 1) % Int32) & 0x18) << 0x0d) + ((threadIdx()).x - 1) % Int32)]::Int4x8
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E_1 = E_mem[1 + ((loopIdx4 % Int32) << 0x16 + (loopIdx3 % Int32) << 0x12 + (((blockIdx()).x - 1) % Int32) << 0x08 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x05 + ((((threadIdx()).y - 1) % Int32) & 0x18) << 0x0d) + ((threadIdx()).x - 1) % Int32 + 32768)]::Int4x8
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1391 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1378 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds K = K_mem[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)]::Int16x2
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1631 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1599 =#
                                    (Kd_0, Kd_1) = convert(NTuple{2, Int32}, K)
                                end
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:703 =#
                                Kd0 = Kd_0
                                Kd1 = Kd_1
                            end
                            begin
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x18) >>> 0x03 + Kd0)] = E′d0
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x18) >>> 0x03 + Kd1)] = E′d1
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:565 =#
                                sync_threads()
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E0_0 = E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09))]::Int4x8
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E0_1 = E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + 128)]::Int4x8
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E0_2 = E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + 2048)]::Int4x8
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds E0_3 = E_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x03 + ((((threadIdx()).y - 1) % Int32) & 0x1c) << 0x02) + ((((threadIdx()).x - 1) % Int32) & 0x0c + ((((threadIdx()).x - 1) % Int32) & 0x10) << 0x04 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x09) + (128 + 2048))]::Int4x8
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1391 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1372 =#
                                    E1_0 = GPUIndexSpaces.get_lo8(E0_0, E0_1)
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1373 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1493 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1461 =#
                                    mask = 0x00000010
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1464 =#
                                    isthread1 = (((threadIdx()).x - 1) % Int32) & mask ≠ 0
                                end
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1474 =#
                                    E2_0 = E1_0
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1475 =#
                                    E2_1 = E1_1
                                    ...
                                    src′ = src.val::UInt32
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1478 =#
                                    dst′ = shfl_xor_sync(0xffffffff, src′, mask)::UInt32
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1479 =#
                                    dst = (Int4x8)(dst′)::Int4x8
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1480 =#
                                    if isthread1
                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1481 =#
                                        E2_0 = dst
                                    else
                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1483 =#
                                        E2_1 = dst
                                    end
                                end
                                begin
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1631 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1620 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Gin0_0 = Gin_mem[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)]::Int8x4
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Gin0_2 = Gin_mem[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32 + 64)]::Int8x4
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Gin0_4 = Gin_mem[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32 + 32)]::Int8x4
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Gin0_6 = Gin_mem[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32 + (32 + 64))]::Int8x4
                            end
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1713 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1699 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:849 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:739 =#
                                Ẽ0_0 = Ẽre_0
                                Ẽ0_1 = Ẽre_1
                                Ẽ0_2 = Ẽre_2
                                Ẽ0_3 = Ẽre_3
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1864 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1851 =#
                            ...
                            begin
                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1432 =#
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1422 =#
                                    Ẽ2_0 = Ẽ1_2
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1423 =#
                                    Ẽ2_2 = Ẽ1_0
                                end
                                begin
                                    #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1422 =#
                            ...
                            begin
                                ...
                                for loopIdx1 = Int32(0):Int32(2)
                                    ...
                                    begin
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Ans_0 = Ans_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Ans_1 = Ans_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 32)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Ans_2 = Ans_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 64)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Ans_3 = Ans_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 96)]::Int8x4
                                        end
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:703 =#
                                            Ansre_0 = Ans_0
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1542 =#
                                            begin
                                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1534 =#
                                                Epm_0 = unsafe_add(Ẽ3_0, Ẽ3_4)
                                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1535 =#
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:2032 =#
                                            A_frag = (Ansre_0.val, Ansre_1.val)::NTuple{2, UInt32}
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:2033 =#
                                            B_frag = (Epre_0.val, Epre_1.val)::NTuple{2, UInt32}
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:2034 =#
                                            C_frag = (F0pre_0, F0pre_1, F0pre_2, F0pre_3, F0pre_4, F0pre_5, F0pre_6, F0pre_7)::NTuple{8, Int32}
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:2035 =#
                                            D_frag = WMMA.llvm_wmma_mma_row_col_m16n16k16_s8(A_frag, B_frag, C_frag)::NTuple{8, Int32}
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:2036 =#
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:768 =#
                                        ...
                                        begin
                                            ...
                                            begin
                                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1296 =#
                                                F̃2_0 = F̃1_0
                                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1297 =#
                                                F̃2_1 = F̃1_2
                                            end
                                            begin
                                                #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1296 =#
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_0
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_1
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_2
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_3
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_5
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_6
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1143 =# @inbounds F̃_shared[1 + ((((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] = F̃4_7
                                        end
                                    end
                                end
                            end
                            ...
                            begin
                                ...
                                for loopIdx2 = Int32(0):Int32(2)
                                    ...
                                    begin
                                        ...
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_0 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07))]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_1 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + 64)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_2 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07))]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_3 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + 64)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_4 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + 512)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_5 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + (64 + 512))]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_6 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + 512)]::Int8x4
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds F̃_7 = F̃_shared[1 + (((((threadIdx()).y - 1) % Int32) & 0x07) << 0x02 + (((((threadIdx()).x - 1) % Int32) & 0x18) >>> 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x04) << 0x03 + ((((threadIdx()).x - 1) % Int32) & 0x03) << 0x07) + (64 + 512))]::Int8x4
                                        end
                                        begin
                                            #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:544 =#
                                            for loopIdx1 = Int32(0):Int32(2)
                                                ...
                                                begin
                                                    ...
                                                    begin
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1021 =#
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Aew_0 = Aew_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32)]::Int8x4
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Aew_1 = Aew_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 32)]::Int8x4
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Aew_2 = Aew_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 64)]::Int8x4
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1017 =# @inbounds Aew_3 = Aew_mem[1 + ((loopIdx1 % Int32) << 0x07 + ((threadIdx()).x - 1) % Int32 + 96)]::Int8x4
                                                    end
                                                    begin
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:703 =#
                                                        Aewre_0 = Aew_0
                                                    ...
                                                    begin
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:802 =#
                                                    ...
                                                    begin
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1153 =#
                                                        #= /Users/eschnett/src/jl/GPUIndexSpaces.jl/src/GPUIndexSpaces.jl:1145 =# @inbounds fI_mem[1 + ((loopIdx4 % Int32) << 0x15 + (loopIdx2 % Int32) << 0x0c + (loopIdx1 % Int32) << 0x0a + (((blockIdx()).x - 1) % Int32) << 0x0e + (((threadIdx()).y - 1) % Int32) << 0x05 + ((threadIdx()).x - 1) % Int32)] += fI8
                                                    end
                                                end
                                            end
                                        end

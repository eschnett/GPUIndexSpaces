...
begin
    ...
    begin
        (A0_0, A0_1, A0_2, A0_3) = unsafe_load4_global(
            A_mem,
            1 + (
                ((((blockIdx()).x - Int32(1)) % Int32) & 0x01) << 0x0f +
                (
                    ((((threadIdx()).y - Int32(1)) % Int32) & 0x03) << 0x06 +
                    ((((threadIdx()).y - Int32(1)) % Int32) & 0x1c) << 0x0a
                ) +
                (
                    ((((threadIdx()).x - Int32(1)) % Int32) & 0x06) << 0x01 +
                    ((((threadIdx()).x - Int32(1)) % Int32) & 0x01) << 0x04 +
                    ((((threadIdx()).x - Int32(1)) % Int32) & 0x18) << 0x06
                )
            ),
        )::NTuple{4,Int8x4}
    ...
    for loopIdx1 in Int32(0):Int32(32768 ÷ 128 - 1)
        for loopIdx2 in Int32(0):Int32(128 ÷ 32 - 1)
            (Ecopy_0, Ecopy_1, Ecopy_2, Ecopy_3) = unsafe_load4_global(
                ...
                1 + (
                    ...
                    ((((blockIdx()).x - Int32(1)) % Int32) & 0x7f) << 0x07 +
                    (
                        ((((threadIdx()).y - Int32(1)) % Int32) & 0x03) << 0x05 +
                        ((((threadIdx()).y - Int32(1)) % Int32) & 0x1c) << 0x0e
                    ) +
                    (
                        ((((threadIdx()).x - Int32(1)) % Int32) & 0x07) << 0x02 +
                        ((((threadIdx()).x - Int32(1)) % Int32) & 0x18) << 0x0b
                    )
                ),
            )::NTuple{4,Int4x8}
            begin
        ...
        unsafe_store4_global!(
            ...
            (
                ...
                ((((threadIdx()).y - Int32(1)) % Int32) & 0x1f) << 0x16 +
                (
